/** @preserve 
jSignature v2-p1 "${buildDate}" "${commitID}"
...
/*	var lineoffset = Math.round( ch / 5 );
	basicLine(ctx, 0, ch - lineoffset, cw, ch - lineoffset);
	basicLine(ctx, 0, ch - lineoffset*2, cw, ch - lineoffset*2);
	var textoffset = Math.round( ch / 8 );
	basicLine(ctx, 0, textoffset, cw, textoffset);
...
//				if (!elementIsOrphan(this)) {
				return	new jSignatureClass(this, options, jSignatureInstanceExtensions)					
//				}
//			})
		}
